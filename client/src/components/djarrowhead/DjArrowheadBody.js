        ...
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="col-md-10 col-md-offset-1" style={{background:'#fff', padding:40, marginTop:20}}>
                   ...
                   <p style={{fontSize:22, fontWeight:700, paddingBottom:10}}>
                   DJ Night With DJ Arrowhead
                    </p>
                    ...
                    <div className="col-md-10">
                       <p>Date: Sat 31 Dec 2020 at 6: 00 PM</p>
                    </div>
                   </div>
                </div>
             ...
             <div className="row">
                    <div className="col-md-10 col-md-offset-1" style={{background:'#fff', padding:40, marginTop:20, marginBottom:20}}>
                        ...
                        <div className="row">
                           ...
                           <p style={{fontSize:18}}>
                           One of the best DJ of Sikkim, DJ Arrowhead and his music is sure to give you the best musical experience. 🔥
                           </p>
                           </div>
                        </div>
                   </div>
...
export default DjArrowheadBody;